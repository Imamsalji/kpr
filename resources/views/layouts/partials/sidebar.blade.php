    ...
    @if (auth()->user()->role == '0')
        <div class="logo-wrapper">
            <a href="{{ route('home') }}"><img class="img-fluid for-light"
                    ...
                    style="height: 100px; width: 200px; object-fit: cover;"><img class="img-fluid for-dark"
                    src="{{ asset('assets/images/logo/logowebdark.png') }}" alt="logowebsite"
                    style="height: 100px; width: 200px; object-fit: cover;"></a>
            <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
        </div>
        <div class="logo-icon-wrapper">
            <a href="{{ route('home') }}"><img class="img-fluid" src="{{ asset('assets/images/logo/logoweb.png') }}"
                    alt="logowebsite" style="height: 20px; width: 20px; object-fit: cover;"></a>
        </div>
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links custom-scrollbar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                data-feather="users"></i><span>Kelola User</span></a>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                data-feather="book-open"></i><span>Rekap Data KPR</span></a>
                        <ul class="sidebar-submenu">
    ...
    @if (auth()->user()->role == '1')
        ...
        <div class="logo-icon-wrapper">
            <a href="{{ route('home') }}"><img class="img-fluid"
                    src="{{ asset('assets/images/logo/logoweb.png') }}" alt="logowebsite"
                    style="height: 20px; width: 20px; object-fit: cover;"></a>
        </div>
        <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
                ...
                <ul class="sidebar-links custom-scrollbar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="{{ route('kalkulator') }}"><i data-feather="dollar-sign"></i><span>Kalkulator
                                KPR</span></a></li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="#"><i
                                data-feather="file-plus"></i><span>Pinjaman</span></a></li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="#"><i
                                data-feather="plus-circle"></i></i><span>Bayar Angsuran</span></a></li>
                    {{-- @endif --}}
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                data-feather="user"></i><span>My Profile</span>
                        </a>
